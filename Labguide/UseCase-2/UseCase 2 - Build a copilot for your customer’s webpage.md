...
[Objective & Scenario [2](#objective-scenario)](#objective-scenario)

[Objective [3](#objective)](#objective)

[Solution Focus Area [3](#solution-focus-area)](#solution-focus-area)

[Persona and Scenario [3](#persona-and-scenario)](#persona-and-scenario)

[Pre-requisites [4](#pre-requisites)](#pre-requisites)

[Lab Instructions [4](#lab-instructions)](#lab-instructions)

[EXCERSIE 1: SETTING UP AND CONFIGURING DYNAMIC 365 CUSTOMER SERVICE
[5](#excersie-1-setting-up-and-configuring-dynamic-365-customer-service)](#excersie-1-setting-up-and-configuring-dynamic-365-customer-service)

[Task 1: Sign Up for Dynamics 365 Customer Service Trial
[5](#task-1-sign-up-for-dynamics-365-customer-service-trial)](#task-1-sign-up-for-dynamics-365-customer-service-trial)

[Task 2: Manage a User in Omnichannel for Customer Service
[10](#task-2-manage-a-user-in-omnichannel-for-customer-service)](#task-2-manage-a-user-in-omnichannel-for-customer-service)

[Task 3: Configure Omnichannel Power Virtual Agent Extension
[13](#task-3-configure-omnichannel-power-virtual-agent-extension)](#task-3-configure-omnichannel-power-virtual-agent-extension)

[Task 4: Configure Search Settings in the Power Platform Admin Center
[15](#task-4-configure-search-settings-in-the-power-platform-admin-center)](#task-4-configure-search-settings-in-the-power-platform-admin-center)

[Conclusion [20](#conclusion)](#conclusion)

[EXERCISE 2: SIGNUP FOR POWER APP AND COPILOT STUDIO
[20](#exercise-2-signup-for-power-app-and-copilot-studio)](#exercise-2-signup-for-power-app-and-copilot-studio)

[Task 1: Sign Up for Microsoft Power Apps
[20](#task-1-sign-up-for-microsoft-power-apps)](#task-1-sign-up-for-microsoft-power-apps)

[Task 2: Sign up for Copilot Studio
[22](#task-2-sign-up-for-copilot-studio)](#task-2-sign-up-for-copilot-studio)

[Conclusion [23](#conclusion-1)](#conclusion-1)

[EXERCISE 3: CREATE CUSTOM TABLES
[23](#exercise-3-create-custom-tables)](#exercise-3-create-custom-tables)

[Task 1: Create a Solution in Power Apps
[23](#task-1-create-a-solution-in-power-apps)](#task-1-create-a-solution-in-power-apps)

[Task 2: Set the Preferred Solution
[27](#task-2-set-the-preferred-solution)](#task-2-set-the-preferred-solution)

[Task 3: Create the "Book Appointments" Table
[28](#task-3-create-the-book-appointments-table)](#task-3-create-the-book-appointments-table)

[Task 4: Create the "Refund Requests" Table
[33](#task-4-create-the-refund-requests-table)](#task-4-create-the-refund-requests-table)

[Conclusion [41](#conclusion-2)](#conclusion-2)

[Exercise 4: Build a Copilot in Microsoft Copilot Studio with New AI
Capabilities
[41](#exercise-4-build-a-copilot-in-microsoft-copilot-studio-with-new-ai-capabilities)](#exercise-4-build-a-copilot-in-microsoft-copilot-studio-with-new-ai-capabilities)

[Task 1: Create Contoso Electronics Services Copilot
[41](#task-1-create-contoso-electronics-services-copilot)](#task-1-create-contoso-electronics-services-copilot)

[Task 2: Configure Security and Generative AI
[45](#task-2-configure-security-and-generative-ai)](#task-2-configure-security-and-generative-ai)

[Task 3: Delete Sample Topics
[48](#task-3-delete-sample-topics)](#task-3-delete-sample-topics)

[Task 4: Disable System Topics
[49](#task-4-disable-system-topics)](#task-4-disable-system-topics)

[Task 5: Create Knowledge Base for Copilot
[50](#task-5-create-knowledge-base-for-copilot)](#task-5-create-knowledge-base-for-copilot)

[Task 6: Publish Your Copilot
[54](#task-6-publish-your-copilot)](#task-6-publish-your-copilot)

[Conclusion [55](#conclusion-3)](#conclusion-3)

[Exercise 5: Create and Manage Topics
[55](#exercise-5-create-and-manage-topics)](#exercise-5-create-and-manage-topics)

[Task 1: Create a Topic "Product Information"
[55](#task-1-create-a-topic-product-information)](#task-1-create-a-topic-product-information)

[Task 2: Create a Topic "Return Policy Information"
[59](#task-2-create-a-topic-return-policy-information)](#task-2-create-a-topic-return-policy-information)

[Task 3: Create a Topic “Compare laptop”
[63](#task-3-create-a-topic-compare-laptop)](#task-3-create-a-topic-compare-laptop)

[Task 4: Create a Topic "Book Appointments"
[67](#task-4-create-a-topic-book-appointments)](#task-4-create-a-topic-book-appointments)

[Task 5: Create a Topic "Refund Requests"
[79](#task-5-create-a-topic-refund-requests)](#task-5-create-a-topic-refund-requests)

[Task 6: Configure the Conversation Start Topic
[90](#task-6-configure-the-conversation-start-topic)](#task-6-configure-the-conversation-start-topic)

[Task 7: Configure the Conversational Boosting Topic
[91](#task-7-configure-the-conversational-boosting-topic)](#task-7-configure-the-conversational-boosting-topic)

[Task 8: Use Generative Answers in the System Fallback Topic
[93](#task-8-use-generative-answers-in-the-system-fallback-topic)](#task-8-use-generative-answers-in-the-system-fallback-topic)

[Task 9: Publish the Copilot
[96](#task-9-publish-the-copilot)](#task-9-publish-the-copilot)

[Test the Copilot [96](#test-the-copilot)](#test-the-copilot)

[Conclusion [102](#conclusion-4)](#conclusion-4)

[Exercise 6: Create Power Automate Flow and Integrate Actions
[102](#exercise-6-create-power-automate-flow-and-integrate-actions)](#exercise-6-create-power-automate-flow-and-integrate-actions)

[Task 1: Create Power Automate Flow to Book an Appointment
[102](#task-1-create-power-automate-flow-to-book-an-appointment)](#task-1-create-power-automate-flow-to-book-an-appointment)

[Task 2: Create Action in Copilot for Book Appointments
[111](#task-2-create-action-in-copilot-for-book-appointments)](#task-2-create-action-in-copilot-for-book-appointments)

[Task 3: Create Power Automate Flow to Refund Requests Flow
[115](#task-3-create-power-automate-flow-to-refund-requests-flow)](#task-3-create-power-automate-flow-to-refund-requests-flow)

[Task 4: Create Action in Copilot for Refund Requests
[123](#task-4-create-action-in-copilot-for-refund-requests)](#task-4-create-action-in-copilot-for-refund-requests)

[Task 5: Publish Your Copilot
[128](#task-5-publish-your-copilot)](#task-5-publish-your-copilot)

[Conclusion [129](#conclusion-5)](#conclusion-5)

[Test Your Copilot [129](#test-your-copilot)](#test-your-copilot)

[Final Conclusion [137](#final-conclusion)](#final-conclusion)
...
<img src="./media/image20.png" style="width:6.26806in;height:3.57917in"
alt="A screenshot of a computer Description automatically generated" />
...
<img src="./media/image37.png" style="width:6.26806in;height:2.975in" />
...
<img src="./media/image93.png" style="width:6.26806in;height:2.975in" />
