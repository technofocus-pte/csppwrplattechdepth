...
<table style="text-align: left; width: 100%;">
  ...
  <tbody>
    <tr>
      <td>Prerequisites</td>
      <td>To get the most out of this lab guide we recommend you have Admin Tenant ID and Password. Trial access with Power Apps, Power Automate Flow, Copilot Studio, Dynamic 365 Customer Service and Return policy lab file.</td>
    </tr>
    <tr>
      <td>Duration</td>
      <td>2 hours</td>
...
# Exercise 1: Setting Up and Confi guring Dynamic 365 Customer Service
...
style="width:6.26806in;height:2.9625in" /><span id="_Toc176443049"
class="anchor"></span>
...
3.  After clicking **"Get it now,"** you'll be prompted to select an
    ...
    <img src="./media/image12.png" style="width:6.26806in;height:2.99306in"
alt="A screenshot of a computer Description automatically generated" />
...
5.  Once the extension is installed, Dynamic 365 apps page will open,
    ...
    **Update available** status and click on the **update available.**
    ...
    <img src="./media/image14.png" style="width:6.26806in;height:3.57917in"
alt="A screenshot of a computer Description automatically generated" />
...
6.  For each app with an update available, select the checkbox to agree
    ...
    <img src="./media/image15.png" style="width:4.81667in;height:5.03333in"
alt="A screenshot of a computer Description automatically generated" />
...
4.  Ensure that **Omnichannel for Customer Service** is installed. This
    ...
    **CustomerService Trial** environment, enabling you to configure the
    ...
    <img src="./media/image18.png" style="width:6.26806in;height:3.85208in"
alt="A screenshot of a computer Description automatically generated" />
...
7.  Under **Product**, select **Features**. This section allows you to
    ...
    <img src="./media/image20.png" style="width:6.26806in;height:4.12778in"
alt="A screenshot of a computer Description automatically generated" />

8.  n the **Features** section, you’ll find several options related to
    ...
    <img src="./media/image21.png" style="width:6.26806in;height:3.67986in"
alt="A screenshot of a computer Description automatically generated" />
...
10. Click the **Save** button located at the bottom right to apply the
    ...
    <img src="./media/image22.png" style="width:6.26806in;height:4.30208in"
alt="A screenshot of a computer Description automatically generated" />
...
2.  Pick an account window will pop up, select your same account. If
    prompted to sign in, enter your same **ID and Password** which we
    use in power apps, then select Sign in.
...
style="width:6.26806in;height:2.4873in" />
...
8.  After entering these details, click **Save**.
    ...
    <img src="./media/image31.png" style="width:6.26806in;height:2.975in" />
...
Address**, and save.
    ...
    <img src="./media/image43.png" style="width:6.26806in;height:2.375in" />
...
3.  On the left navigation pane, find and click on **Create**. Then,
    ...
    > **Note:** The **Create a Copilot** wizard will open. This wizard
guides you through the process of setting up your copilot by allowing
you to name it, choose the language, and optionally enable generative
answers to enhance conversations.
...
style="width:4.95098in;height:2.36414in" />
...
2.  In the top bar, select **Topics** which is located next to
    **Knowledge**.
    ...
    <img src="./media/image88.png" style="width:6.26806in;height:2.975in" />
...
3.  Click on **+ Add a topic** to create a new topic. Choose **From
    ...
    <img src="./media/image97.png" style="width:6.26806in;height:2.975in" />
...
5.  In the canvas, you'll see a **Trigger node**. In the **Describe**
    ...
    > **compare laptop, compare product, laptop comparison, compare between laptops**
...
## Task 5: Create a Topic "Refund Request"
...
9.  In the Adaptive Card properties, below the **Edit JSON** paste the
    ...
    <img src="./media/image137.png" style="width:6.26806in;height:2.94444in" />
...
7.  Select the **Microsoft Surface website** and the **Return Policy**
...
11. From the list of available sources, select the **Microsoft Surface
    website** and **Return Policy Doc** as the knowledge source.
...
11. Login with the same credential for the Oath Sign.
...
8.  After mapping all the variables, click on the **Save** button to
    ...
    <img src="./media/image196.png" style="width:6.26806in;height:2.95in" />

## Task 3: Create Power Automate Flow to Refund Request Flow
...
7.  Select **Text** for the input type and configure the following
    ...
    <img src="./media/image204.png" style="width:6.26806in;height:2.75in" />
...
13.  Use **Dynamic content** to map each input parameter to the
    corresponding field:
     ...
     10. **Contact Method** Dynamic Input → **Preferred Contact Method**
        ...
        <img src="./media/image210.png" style="width:6.26806in;height:2.72917in" />

        <img src="./media/image211.png" style="width:6.26806in;height:2.78542in" />
...
5.  Select the **Refund Request** topic.
...
8.  Choose the **Refund Request Flow**. This action will now be added
...
9.  In the action node, you need to map each input field to the
    ...
    10. **Description** Input: Click on the input field, then select
        **description** from the custom variables.
        ...
        <img src="./media/image220.png" style="width:6.26806in;height:2.91528in" />

        <img src="./media/image221.png" style="width:6.26806in;height:2.97708in" />

10. After mapping all the variables, click on the **Save** button to
    save the topic configuration.

    <img src="./media/image222.png" style="width:6.26806in;height:2.96528in" />
