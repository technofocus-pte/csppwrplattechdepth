...
<table border="1">
  ...
  <tr>
    ...
    <td>To get the most out of this lab guide we recommend you have admin access with Power Apps, Power Automate Flow, Copilot Studio, Dynamic 365 Customer Service and Return policy lab file.</td>
  </tr>
  <tr>
...
8.  In the **Features** section, you’ll find several options related to
    ...
    - **Dataverse Search**: This feature enhances the overall search
        capability, making it easier to find records across the
        Dataverse.

    - **Single Table Search**: This allows you to perform searches
...
4.  **Appointment Type Column:**
    ...
    - Click on the down arrow next to the first column, and then
        select the edit column button.

        <img src="./media/image45.png"
style="width:5.88362in;height:2.78341in" />

    - Change the display name to **Appointment Type** and click on
    **Save**.
...
to enhance conversa
    ...
    ![image67](https://github.com/user-attachments/assets/9d53c3cc-1882-4520-935c-e566cca5d1c2)
...
9.  In the Adaptive Card properties, go to the **Edit JSON** section.
    ...
    - Paste the provided **JSON** code to create the adaptive card.
    
    - **OR** use the **Open Adaptive Card Designer** option to design
...
```
{
    ...
    "body": [
        ...
        },
        {
            "type": "Input.Text",
            "id": "description",
            "placeholder": "Provide a brief description of the issue or reason for return/exchange",
            "label": "Description",
            "isMultiline": true,
            "isRequired": true,
...
5.  Enter the following trigger phrases to test the topics you created:
    ...
    - What are some deals on student laptops right now?
...
style="width:6.26806in;height:2.96875in" />
    ...
    _ Tell me more about Surface Laptop Go 3. What are the specs & cost?
...
style="width:6.26806in;height:2.95208in" />
    ...
    - Compare laptop surface laptop pro 3 and surface laptop studio 2.
...
6.  Enter the following trigger phrases to test the topics you created:
    ...
    - I want to know about the Contoso refund policy.
...
style="width:6.26806in;height:2.95556in" />
    ...
    - I buy laptop 10 days ago, is I eligible to return laptop.
...
7.  Select **Text** for the input type and configure the following
    ...
    - Enter **Type** in input field for Appointment Type
    
    - Enter **Date** in input field for Appointment Date
    
    - Enter **Email** in input field for Email Address
    
    - Enter **Name** in input field for Full Name
    
    - Enter **Phone** in input field for Phone Number
    
    - Enter **Time** in input field for Appointment Time
...
14. Use **Dynamic content** to map each input parameter to the
    ...
    - **Type** Dynamic Input → **Appointment Type** Parameter.
    
    - **Date** Dynamic Input → **Appointment Date** Parameter
    
    - **Email** Dynamic Input → **Email Address** Parameter
    
    - **Name** Dynamic Input → **Full Name** Parameter
    
    - **Phone** Dynamic Input → **Phone Number** Parameter
    
    - **Time** Dynamic Input → **Appointment Time** Parameter
...
9.  In the action node, you need to map each input field to the
    ...
    - **Type** Input: Click on the input field, then select
            **Appointmenttype** from the custom variables.
    
    - **Date** Input: Click on the input field, then select
            **appointmentDate** from the custom variables.
    
    - **Email** Input: Click on the input field, then select
            **contactEmail** from the custom variables.
    
    - **Name** Input: Click on the input field, then select
            **fullName** from the custom variables.
    
    - **Phone** Input: Click on the input field, then select
            **contactPhone** from the custom variables.
    
    - **Time** Input: Click on the input field, then select
...
7.  Select **Text** for the input type and configure the following
    ...
    - Enter **Name** in Input for Full Name
    
    - Enter **Email** in Input for Email
    
    - Enter **Phone Number** in Input for Phone Number
    
    - Enter **Purchase Date** in Input for Date of Purchase
    
    - Enter **Description** in Input for Description
    
    - Enter **Order Number** in Input for Order Number
    
    - Enter **Order Type** in Input for Order Type
    
    - Enter **Product** in Input for Product
    
    - Enter **Receipt Number** in Input for Appointment Type
    
    - Enter **Contact Method** in Input for Preferred Contact Method
...
13. Use **Dynamic content** to map each input parameter to the
    ...
    - **Purchase Date** Dynamic Input → **Date of Purchase** Parameter.
    
    - **Description** Dynamic Input → **Description** Parameter.
    
    - **Email** Dynamic Input → **Email** Parameter.
    
    - **Order Number** Dynamic Input → **Order Number** Parameter.
    
    - **Order Type** Dynamic Input → **Order Type** Parameter.
    
    - **Phone Number** Dynamic Input → **Phone Number** Parameter.
    
    - **Product** Dynamic Input → **Product** Parameter.
    
    - **Receipt Number** Dynamic Input → **Receipt Number** Parameter.
    
    - **Contact Method** Dynamic Input → **Preferred Contact Method**
            Parameter.    
...
9.  In the action node, you need to map each input field to the
    ...
    - **Email** Input: Click on the input field, then select **email**
        from the custom variables.

    - **Phone Number** Input: Click on the input field, then select
            **phoneNumber** from the custom variables.
    
    - **Product** Input: Click on the input field, then select
            **product** from the custom variables.
    
    - **Contact Method** Input: Click on the input field, then select
            **contactMethod** from the custom variables.
    
    - **Order Type** Input: Click on the input field, then select
            **orderType** from the custom variables.
    
    - **Receipt Number** Input: Click on the input field, then select
            **receiptNumber** from the custom variables.
    
    - **Order Number** Input: Click on the input field, then select
            **orderNumber** from the custom variables.
    
    - **Purchase Date** Input: Click on the input field, then select
            **purchaseDate** from the custom variables.
    
    - **Description** Input: Click on the input field, then select
...
style="width:6.26806in;height:2.96875in" />
    ...
    - Tell me more about Surface Laptop Go 3. What are the specs & cost?
...
style="width:6.26806in;height:2.94792in" />
    ...
    - Book Appointment for further assistance
...
style="width:6.26806in;height:2.96389in" />
    ...
    - I buy laptop 3 day ago; I have to submit refund request.
